// Composition
// Composition represents a strong "has-a" relationship where the child object cannot exist independently of the parent object. The lifetime of the child is controlled by the parent.
// Key Characteristics:
// Strong ownership
// Child objects are created and destroyed with the parent
// Typically implemented with object members (not pointers)
